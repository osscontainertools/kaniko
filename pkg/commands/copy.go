...
func (c *CopyCommand) IsArgsEnvsRequiredInCache() bool {
	return referencesArgOrEnv(c.cmd.String())
}
...
func referencesArgOrEnv(instruction string) bool {
	return strings.Contains(instruction, "$")
}
...
func (cr *CachingCopyCommand) IsArgsEnvsRequiredInCache() bool {
	return referencesArgOrEnv(cr.String())
}
