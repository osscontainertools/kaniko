...
var additionalDockerFlagsMap = map[string][]string{
	"Dockerfile_test_issue_519":                  {"--target=final_stage"},
	"Dockerfile_test_multistage_args_issue_1911": {"--target=base-custom2"},
	"Dockerfile_test_cmd":                        {"--target=final"},
	...
	"Dockerfile_test_issue_mz511":                {"--secret=id=netrc,src=context/foo", "--target=second"},
	...
	"Dockerfile_test_pre_defined_build_args":       {"--provenance=false", "--target=final"},
	...
	"Dockerfile_test_issue_1837":                   {"--provenance=false", "--target=final"},
	"Dockerfile_test_issue_2049":                   {"--provenance=false"},
	"Dockerfile_test_issue_1039":                   {"--provenance=false", "--target=final"},
